...
cogTable <- cogTable %>% rename(gc = model) # change the name of the column to be able to use facet_wrap
...
coG_Map <- function(spc){
  #spc <- spcs[13] # Run and comment (after)
