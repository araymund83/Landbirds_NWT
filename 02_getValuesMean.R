#This script gets the values of the mean rasters and convert then into a table with year and gcm
# Load libraries --------------------------------------------------------
require(pacman)

pacman::p_load(raster, rgdal, rgeos, terra, stringr, glue, sf, 
               tidyverse, RStoolbox, fs, fst, trend)
